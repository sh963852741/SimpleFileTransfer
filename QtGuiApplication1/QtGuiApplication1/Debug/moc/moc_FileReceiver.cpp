...
QT_MOC_LITERAL(5, 49, 15), // "ReceiveFinished"
...
void FilesReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FilesReceiver::*)(QString , QTime );
        ...
        {
            using _t = void (FilesReceiver::*)(unsigned short , QString , QTime );
...
// SIGNAL 0
void FilesReceiver::BeginRecvSingleFile(QString _t1, QTime _t2)
{
...
// SIGNAL 1
void FilesReceiver::ReceiveFinished(unsigned short _t1, QString _t2, QTime _t3)
{
