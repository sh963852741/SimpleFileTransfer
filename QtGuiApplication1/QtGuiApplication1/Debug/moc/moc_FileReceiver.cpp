...
QT_MOC_LITERAL(1, 14, 13), // "SingleFileGot"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14), // "BeginListening"
QT_MOC_LITERAL(4, 44, 13), // "StopListening"
QT_MOC_LITERAL(5, 58, 18), // "SingleFileFinished"
QT_MOC_LITERAL(6, 77, 17), // "ReceiveSingleFile"
QT_MOC_LITERAL(7, 95, 6), // "SOCKET"
QT_MOC_LITERAL(8, 102, 6), // "socket"
QT_MOC_LITERAL(9, 109, 13) // "StopReceiving"

    },
    "FilesReceiver\0SingleFileGot\0\0"
    "BeginListening\0StopListening\0"
    "SingleFileFinished\0ReceiveSingleFile\0"
    "SOCKET\0socket\0StopReceiving"
};
#undef QT_MOC_LITERAL
...
void FilesReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SingleFileGot(); break;
        case 1: _t->BeginListening(); break;
        case 2: _t->StopListening(); break;
        case 3: _t->SingleFileFinished(); break;
        case 4: _t->ReceiveSingleFile((*reinterpret_cast< SOCKET(*)>(_a[1]))); break;
        case 5: _t->StopReceiving(); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FilesReceiver::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FilesReceiver::SingleFileGot)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilesReceiver::SingleFileGot()
{
...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "SingleFileReceiver\0finished\0"
};
#undef QT_MOC_LITERAL
...
void SingleFileReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SingleFileReceiver::*)();
...
// SIGNAL 0
void SingleFileReceiver::finished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}
QT_WARNING_POP
